  ...
  <div class="data-base">
    <div class="inner-warp">
      ...
      <div class="section-warp">
        ...
        <LoginCard ref="loginCard" v-show="!isLogin" @on-login="handleOnLogin" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleAdd(data) {
      ...
      if (this.cypher.toLowerCase().indexOf("create") > -1) {
        this.$refs.loginCard.handleButton({
          pandadbUrl: this.loginData.pandadbUrl,
          username: this.loginData.username,
          password: this.loginData.password,
        });
    ...
    .query-input {
      ...
      .button-warp {
        i {
          ...
          width: 32px;
          height: 32px;
          background: url("../../../assets/atlas/run1.png") center center
            no-repeat;
          background-size: 70%;
          &:hover {
            background: url("../../../assets/atlas/run2.png") center center
              no-repeat;
          }
        }
      }
